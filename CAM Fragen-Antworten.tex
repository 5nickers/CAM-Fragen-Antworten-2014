...
Abteilung: Montage und Fertigung

\subsection*{%
    Nennen Sie drei verschiedene Möglichkeiten zur Programmierung von
    NC-Maschinen und beschreiben Sie in Stichworten die Unterschiede. %%%%%%%%%%%%%%% die da wären? Oder sind die Antwort der nächsten Frage tatsächlich die Unterschiede?
}

\begin{enumerate}[1)]
    \item manuelle Steuerung: direkte Programmierung an der Maschine\\
    	\emph{Problem/Unterschied:} andere Bedienoberfläche, andere Worte/Sätze in Programmiersprache
    \item manuell extern: direkte Programmierung an einem externen Gerät
    \item Programmierung mit Hilfe einer grafischen Oberfläche und interaktiv; \\
    	\emph{grafisch:} Darstellung der Geometrie des Werkstücks auf dem Bildschirm\\
    	\emph{interaktiv:} Eingabe der Geometrie, Verfahrwege, etc. im Dialog mit dem Rechner\\
    	$\Rightarrow$ Schritt-für-Schritt-Benutzung; Vorteil: weniger Fehler, Arbeitsaufwand verringern, nachträgliche Änderungen erleichtern
    \item Programmierung mit Hilfe einer grafischen Oberfäche und CAD-Kopplung
    \item
        Programmierung mit Hilfe einer grafischen Oberfäche und integriertem
        CAM-System
\end{enumerate}

\subsection*{%
    Was versteht man unter „graphisch interaktiver NC-Programmierung“. Erläutern Sie drei Merkmale in Stichworten
}
...
\begin{itemize}
    ...
    \item
        ...
        es kann kontrolliert und korrigiert werden
    \item Schritt-für-Schritt-Programmierung
    \item Möglichkeit zur Kopplung an CAD
\end{itemize}

\subsection*{%
    Nennen Sie beispielhaft 5 Einsatzkriterien für graphisch interaktive Programmierung
}
...
\begin{description}
    ...
    \item[STL] Surface Tesselation Language
\end{description} 
...
\subsection*{%
    Die Feature Technologie besitzt ein erhebliches Potenzial zur Beschleunigung
...
erfasst, sondern auch die hinterlegten Informationen – die sogenannte „Semantik“
...
\subsection*{%
    Beschreiben sie in Stichpunkten den Unterschied zwischen „konventionellen“ und feature-basierten CAD-Systemen.
}
...
\subsection*{%
    ...
    Konstruktionsfeature\grqq {} und \glqq Fertigungsfeature\grqq
}
...
\subsection*{
Welche Fragen gibt es zur Featureerkennung?
}
...
\begin{itemize}
    ...
    \item Komponenteneinsparung durch Technologiestandardisierung
...
\section{
Auswahl von CAM-Systemen
}

\subsection*{%
    Nennen Sie mögliche Gesichtspunkte bei der Auswahl eines CAM-Systems.
}

\begin{itemize}
	\item steigende Komplexität der Fertigung
	\item Kundenanforderung
	\item Wechsel des CAD-Systems
	\item Anpassung an Unternehmensstrategie mit CIM-Zielen
	\item Wirtschaftlichkeit steigern
\end{itemize}

\subsection*{
Nennen Sie Argumente, die für/gegen die Hinzuziehung eines externen Beraters bei der CAM-System-Auswahl sprechen könnte.
}
\begin{itemize}[+]
	\item Betriebsblindheit ausschließen
	\item Erfahrung in Projekten
	\item Kenntnis von CAM
	\item Fachübergreifende Kompetenz
\end{itemize}
\begin{itemize}[–]
	\item hohe Kosten
	\item Geheimhaltung kritisch
	\item Standardlösungsansatz
	\item keine neutrale Beratung
\end{itemize}

\subsection*{
Nennen Sie Themen, die im Pflichtenheft zur Auswahl von CAM-Systemen auftauchen sollten und erläutern sie diese.
}
...
siehe auch auf den Seiten 29 bis 41 des Skripts VL-05-CAM-14-Ju.pdf –
