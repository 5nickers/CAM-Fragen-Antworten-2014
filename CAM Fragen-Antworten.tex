...
\begin{enumerate}[1)]
    ...
    \item Programmierung mit Hilfe einer graphischen Oberfäche und CAD-Kopplung
    \item
        Programmierung mit Hilfe einer graphischen Oberfäche und integriertem
        CAM-System
\end{enumerate}
...
\subsection*{%
    Nennen Sie beispielhaft 5 Einsatzkriterien für graphisch interaktive
    Programmierung
}
